...
export const canisterId = process.env.ONEWEB3_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./oneweb3.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the oneweb3 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./oneweb3.did.js")._SERVICE>}
 */
export const oneweb3 = createActor(canisterId);
