...
const Footers: FunctionComponent = () => {
  return (
    <footer className="absolute top-[1504px] left-[0px] bg-black1 flex flex-row items-start justify-start py-[41px] px-[126px] gap-[108px] text-left text-xl text-gray-white font-montserrat md:flex-col">
