...
import { idlFactory } from './oneweb3_frontend.did.js';
export { idlFactory } from './oneweb3_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ONEWEB3_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./oneweb3_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the oneweb3_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./oneweb3_frontend.did.js")._SERVICE>}
 */
export const oneweb3_frontend = createActor(canisterId);
